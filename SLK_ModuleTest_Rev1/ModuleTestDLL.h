...
int MTDLLAPI MT_Load_COM_Port(int* PortCnt, uint64_t MYCOMPORT[], unsigned char *DataDir_in);
...
int MTDLLAPI MT_ImageScan(int PortCnt, char *SNLogFile, char* fnappd, bool GUIShow, int NumFrame);
	...
	//@brief	Image Scan Auto
	//@detail	Perform image scan auto
	//@param	PortCnt - number of ports / testers connected
	//			NumFrame - frame number of images that will be scanned
	//@retval	MTDLL_OK - success
	//			MTDLL_ERROR - fail
int MTDLLAPI MT_ImageScan_Auto(int PortCnt, int NumFrame);
...
int MTDLLAPI MT_Chk_PassBit(int PortCnt, int STPassout[], int MTPassout[], int DieIDout[]);
	...
	//@brief	Dummp OTP Trim Content
	//@detail	Dummp OTP Trim Content
	//@param	PortCnt - number of ports / testers connected
	//@retval	MTDLL_OK - success
	//			MTDLL_ERROR - fail
int MTDLLAPI MT_OTPTrimDump(int PortCnt);
